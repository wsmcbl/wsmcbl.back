...
values ('1001', 'Ezequilito', 'De jesús', 'Urbina', 'Zeledón', 'ez-user1001', '12345', 'ezequielurbinaxoxoxo@gmail.com',
        true),
...
-- ############################## ---
insert into secretary.schoolyear(label, startdate, deadline, isactive)
values ('2024', '01/01/2024', '31/12/2024', true),
...
insert into secretary.grade(gradelabel, schoolyear, quantity, modality)
values ('11vo', 'sch011', 100, 'secundaria'),
...
insert into secretary.subject(gradeid, name, ismandatory)
values ('gd00034', 'Matematicas', true),
...
-- ############################## ---
insert into academy.enrollment (enrollmentlabel, section, schoolyear, capacity, quantity, gradeid)
values ('11A', 'A', 'sch014', 30, 28, 'gd00034'),
...
insert into academy.subject(subjectid, teacherid, enrollmentid)
values ('sub000014', 'tch-001', 'enr00086'),
...
insert into accounting.tariff(schoolyear, concept, amount, duedate, late, typeid, modality)
values ('sch011', 'Pago mes noviembre', 700, '28/11/2023', true, 1, 3),
