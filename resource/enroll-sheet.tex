...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item Estar de acuerdo que el colegio grabe las aulas para garantizar la seguridad de los estudiantes.
    \end{itemize}
    Seré atendido en horario especial por los docentes.
    El docente guía será el responsable de dar respuesta a cualquier situación que se presente con mi hijo.
    Mis reclamos y sugerencias las haré por escrito a la dirección académica con el propósito de obtener una respuesta satisfactoria.
    Mi hijo será respetado y tratado con igualdad, será estimulado al destacarse en sus actividades escolares, recibirá el apoyo de
    la dirección y docentes, contará con todas las horas de clases indicadas en el horario y disfrutará de todos los derechos establecidos.

    Comprendo que el apoyo de los padres \textbf{es insustituible} para mejorar el rendimiento académico y la disciplina estudiantil, y me comprometo a contribuir en ello.
    \vfill
    \begin{center}
        \rule{7cm}{0.4pt}\\
