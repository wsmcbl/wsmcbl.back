...
\fancyhead[C]
{
    \makebox[\textwidth]{
        ...
        \begin{minipage}[c][2.5cm]{0.2\textwidth}
            \includegraphics[width=2.5cm]{image/cbl-logo-wb}
        \end{minipage}
        \hspace{0.01\textwidth}
        \begin{minipage}[c][2.5cm]{0.6\textwidth}
            \centering
            \textbf{\LARGE Colegio Bautista Libertad}\\[0.2cm]
            \textbf{\Large Boleta escolar \schoolYear}\\[0.1cm]
...
\newcommand{\department}{departament.value}
...
\begin{document}
    ...
    \aDupleCenter{Docente guía:}{\teacherName}\\
    \aDupleCenter{Director:}{\principalName}\\
