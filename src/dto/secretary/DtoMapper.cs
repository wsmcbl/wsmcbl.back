...
public static class DtoMapper
{
    ...
    public static DegreeDto mapToDto(this DegreeEntity degree) => new(degree);
    public static DegreeToCreateDto mapToCreateDto(this DegreeEntity degree) => new(degree);
